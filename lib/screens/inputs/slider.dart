import 'package:fluent_ui_flutter_starter/widgets/card_highlight.dart';
import 'package:fluent_ui_flutter_starter/widgets/page.dart';
    ...
    return ScaffoldPage.scrollable(
      ...
      children: [
        const Text(
          ...
          'as a relative quantity, not a numeric value. For fluent_ui_flutter_starter, users think '
...
''',
    ...
    *   Use a natural orientation. For fluent_ui_flutter_starter, if the slider represents a real-world value that is normally shown vertically (such as temperature), use a vertical orientation.
