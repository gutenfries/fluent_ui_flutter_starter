...
import 'package:fluent_ui_flutter_starter/constants.dart';
              ...
              commandBar: Row(children: [
                Link(
                  ...
                  builder: (context, open) => Tooltip(
                    message: 'Source code',
                    child: IconButton(
                      icon: const Icon(TablerIcons.git_branch, size: 24.0),
                      onPressed: open,
                    ),
                  ),
                ),
      ...
      children: [
        Card(
          child:
            ...
            InfoLabel(
              label: 'Icons',
              child: const Icon(TablerIcons.brand_github, size: 30.0),
            ),
            InfoLabel(
              label: 'Colors',
              child: SizedBox(
        ...
        Row(children: [
          ...
          const Icon(TablerIcons.heart, size: 16.0),
        ]),
              ...
              icon: Column(children: [
                SizedBox(
                  ...
                  child: ShaderMask(
                    ...
                    blendMode: BlendMode.srcATop,
                    child: const Icon(TablerIcons.diamond, size: 60),
                  ),
                ),
