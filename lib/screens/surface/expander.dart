      ...
      children: [
        description(
          content: const Text(
            ...
            'text to complex UI layouts. For fluent_ui_flutter_starter, you can use the control to '
        ...
        description(
          content: const Text(
            'In this fluent_ui_flutter_starter, the trailing vanishes when the expander is open.',
          ),
        ),
        CardHighlight(
